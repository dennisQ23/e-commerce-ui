          ...
          {activeStep === 1 ? (
            cartItems.map((item) => (
              ...
              <div key={item.id} className="flex items-center justify-between">
                ...
                {/* Delete Button */}
                <button className="w-8 h-8 rounded-full bg-red-100 text-red-400 hover:bg-red-200 transition-colors duration-300 flex items-center justify-center cursor-pointer">
